...
xst -ifn xst.scr
move DCMto100k_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DCMto100k_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DCMto100k_exdes.ucf DCMto100k_exdes

echo 'Running map'
map -timing -pr b DCMto100k_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm DCMto100k_exdes -w routed.ncd routed.vhd
cd ..
